...
const caseList = [
  { id: nanoid(), value: '允许' },       // Allowed
  { id: nanoid(), value: '拒绝' },       // Denied
  { id: nanoid(), value: '待处理' },     // Pending
  { id: nanoid(), value: '已批准' },     // Approved
  { id: nanoid(), value: '已驳回' },     // Rejected
  { id: nanoid(), value: '已取消' },     // Cancelled
  { id: nanoid(), value: '已完成' },     // Completed
  { id: nanoid(), value: '失败' },       // Failed
]
...
export const metadata: RegisterNodeMetadata<ConditionalPathNodeData> = {
  ...
  detail: {
    ...
    title: '条件分支节点',
    description: '判断某个条件，并根据结果采取不同的路径。',
  },
  connection: {
    inputs: 1,
    outputs: 0,
