...
const conditionList = [
  { id: nanoid(), condition: '用户下单了商品' },          // User ordered a product
  { id: nanoid(), condition: '用户将商品加入购物车' },    // User added a product to cart
  { id: nanoid(), condition: '用户访问了页面' },          // User visited a page
  { id: nanoid(), condition: '用户点击了按钮' },          // User clicked a button
  { id: nanoid(), condition: '用户提交了表单数据' },      // User submitted a form data
]
